...
class MainWindow(QWidget):
    def __init__(self):
        ...
        self.btnLogs.setStyleSheet("color: rgb(255, 255, 255); font: 12pt 'MS PGothic'; background-color: rgb(85, 85, 127);")
        ...
        self.btnInfo.setStyleSheet("color: rgb(255, 255, 255); font: 12pt 'MS PGothic'; background-color: rgb(85, 85, 127);")
        ...
        self.btnMinimize.setStyleSheet('color: rgb(255, 255, 255); font: 12pt "MS PGothic"; background-color: rgb(85, 85, 127);')
        ...
        self.btnClose.setStyleSheet('color: rgb(255, 255, 255); font: 12pt "MS PGothic"; background-color: rgb(85, 85, 127);')
        ...
        self.lbTitle.setText('<html><head/><body><p><span style=" font-size:14pt; font-weight:600; color:#ffffff;">កម្មវិធីទាញយក</span><span style=" font-size:14pt; font-weight:600; color:#ffaa00;"> PIXABAY FOOTAGE VIDEO</span></p></body></html>')
        ...
        self.lbLinkVideo.setText('<html><head/><body><p><span style=" font-size:9pt; font-weight:600; color:#ffffff;">Link Videos</span></p></body></html>')
        ...
        self.txtLinkDownload.setPlaceholderText('Ex: https://pixabay.com/videos/sunset-nature-sky-dubai-111204/')
    ...
    def showInfo(self):
        ...
        <html>
            <body style='font-size: 10pt; color: white; background-color: gray;'>
                <h1>Owner Info</h1>
                <hr>
                <p>កម្មវិធីឈ្មោះ: Pixabay Footage Video Downloader</p>
